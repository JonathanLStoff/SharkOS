...
// OLED assets are defined in `mainmenu.h` (avoid duplicate PROGMEM definitions)
#include "mainmenu.h"
...
#else
// Headless (NO_OLED) stubs kept so other modules can call these safely
void drawmainMenu() { /* no-op for headless builds */ }
void handleMenuAction(int index) { (void)index; /* no-op */ }
void handlemainmenu() { /* no-op */ }
#endif
