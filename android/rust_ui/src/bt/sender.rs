...
fn translate_action_to_bt(action: &str) -> Option<&'static str> {
    ...
    let map: HashMap<&str, &str> = [
        ...
        ("wifi-wireshark", "wifi.capture.start"),
        ("wifi-wireshark-stop", "wifi.capture.stop"),
        ...
        ("sub-ghz-recorder-stop", "subghz.record.stop"),
        ("sub-ghz-packet-sender", "subghz.packet.send"),
        ("sub-ghz-disruptor", "subghz.disruptor.start"),
        ("sub-ghz-smart-disruptor", "subghz.smart.disruptor.start"),
